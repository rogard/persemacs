...
Evaluate (~C-c C-c~)
#+call: el-collect[:post el-wrap(body=*this*,lang="sh",ref="sh-coll")](ref-list='("cat-eof" "hello" "ahoy" "eof") order=':buffer)
...
Evaluate (~C-c C-c~)
#+call: el-collect[:post el-wrap(body=*this*,lang="sh",ref="sh-coll")](ref-list='("cat-eof" "hello" "ahoy" "eof"), order=':ref-list)
