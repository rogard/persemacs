...
#+call: el-collect[:post el-wrap(body=*this*,lang="sh")](ref-list='("foo" "bar" "foo"))

#+RESULTS:
#+header: :noweb-ref new-ref
#+begin_src sh
echo 'Hello, world!'
echo 'Ahoy, planet!'
echo 'Hello, world!'
...
#+call: el-json-object[:post el-wrap(body=*this*,lang="json",ref="json-merge") :results raw](ref-list='("foo" "bar" "qux"), key-list='("foo" "bar" "qux"))
