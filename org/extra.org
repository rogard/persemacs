...
#+begin_src emacs-lisp
(cl-defun erw/noweb-expand-ref (&key regex (sep "\n"))
  ...
  (let ((results '()))
    ...
    (string-join (nreverse results) sep)))
#+end_src
...
#+header: :noweb-ref el-noweb
#+begin_src emacs-lisp
  (cl-defun erw/noweb-expand-ref-collect (&key head ref-list tail sep)
