...
#+header: :noweb-ref el-plist-if
#+begin_src emacs-lisp
  (cl-defmacro er317/inline-plist-if (&rest keyval-list)
...
#+RESULTS:
((:lang sh :body 'Ahoy, planet!' :header-args ((:results . replace) (:exports . code) (:noweb-ref . sh-ahoy) (:tangle . no) (:hlines . no) (:noweb . no) (:cache . no) (:session . none)) :switches  :name nil :start 40410 :coderef (ref:%s)) (:lang sh :body 'Hello, world!' :header-args ((:results . replace) (:exports . code) (:noweb-ref . sh-hello) (:tangle . no) (:hlines . no) (:noweb . no) (:cache . no) (:session . none)) :switches  :name nil :start 40503 :coderef (ref:%s)) (:lang sh :body 'Hello, debugger!' :header-args ((:results . replace) (:exports . code) (:noweb-ref . sh-hello) (:tangle . no) (:hlines . no) (:noweb . no) (:cache . no) (:session . none)) :switches  :name nil :start 40577 :coderef (ref:%s)))
...
#+header: :noweb-ref el-noweb
#+begin_src emacs-lisp
  (cl-defun er317/noweb-ref-iterate-fold
      (&key
       (filter-arglist-base '(:babel-info-key :body))
       filter-arglist-singleton
       (filter-arglist-list (when filter-arglist-singleton
                              (list filter-arglist-singleton)))
       (filter-result-list '())
       (func
        (cond
