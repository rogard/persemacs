...
(let ((config-path '"/home/erwann/github/rogard/persemacs/erw1-config.el")
      (extra-path '"/home/erwann/github/rogard/persemacs/erw1-extra.el"))
(let ((dir-name default-directory))
  (load (expand-file-name config-path dir-name))
  (load (expand-file-name extra-path dir-name)))
)

(let ((init-source '"/home/erwann/github/rogard/persemacs/erw1-init.el"))
